...
public class UnitOfWork : IUnitOfWork
{
    ...
    public IHomeCategoryDisplayRepository HomeCategoryDisplays { get; }
    ...
    public UnitOfWork(
        ...
        IHomeCategoryDisplayRepository homeCategoryDisplays)
    {
        _db = db;
        Users = users;
        Tours = tours;
        ...
        Support = support;
        HomeCategoryDisplays = homeCategoryDisplays;
    }
